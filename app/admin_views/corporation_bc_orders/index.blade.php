    ...
    'method' => 'GET',
      ...
      <div class="row text-center">
        ...
        <div class="col col-xs-2">
          ...
          <a href="{{action('AdminCorporationBcOrdersController@index', ['export'=>'xls'])}}" class="btn btn-primary btn-submit" style="float:right">
...
<table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        {{link_to_action('AdminCorporationBcOrdersController@show', $order->order_id, [$order->order_id])}}
      </td>
      <td>
        {{$order->comments}}
      </td>
      ...
      <td>
       ...
       <td>
   {{Form::open(array('action' =>['AdminCorporationBcOrdersController@destroy',$order->order_id],
   'method' => 'delete'))}}
