			...
			<tbody>
				@foreach($dates_mac as $date_mac)
					<tr>
						...
						<td>	
							{{Form::open(array('action' =>['AdminDatesMacController@destroy',$date_mac->id],
						   'method' => 'delete'))}}
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		{{Form::open(['action' => 'AdminDatesMacController@store','id' => 'form-add-date'])}}  
