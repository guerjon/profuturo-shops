	...
	<script>
		$(function(){
			$('.btn-select').click(function(){
				...
				var id = $(this).attr('data-furniture-id');
				
				var action = laroute.action('AdminFurnitureRequestsController@update',{solicitudes_mobilario:id});
				console.log(action);
				$('#request_select_modal form').attr('action',action);
				$('#request_select_modal').modal();
