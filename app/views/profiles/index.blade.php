	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
	        ...
	        <div class="media-left">
	          {{HTML::image($user->image->url('mini'), $user->nombre, ['class' => 'img-rounded'])}}
		      </div>
				</div>
			</div>
        ...
        {{Form::file('image')}}
			...
			<div class="form-group">
				{{Form::label('extension','Extención',['class'=>'control-label'])}}
				{{Form::text('extension',null,['class' => 'form-control'])}}			
			</div>


			<div class="form-group">
				{{Form::label('num_empleado','Numero de empleado',['class'=>'control-label'])}}
