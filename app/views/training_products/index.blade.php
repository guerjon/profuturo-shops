    ...
    <div class="row">
      ...
      <div class="col-xs-4">
        @if($activeCategory == null)
          {{Form::select('name',[null => 'Todos los productos'] +TrainingProduct::lists('name','name'),null,['class' => 'form-control','id' => 'name'])}}
        @else
          {{Form::select('name',[null => 'Todos los productos'] +TrainingProduct::where('training_category_id',$activeCategory->id)->lists('name','name'),null,['class' => 'form-control','id' => 'name'])}}
        @endif
      </div>
    <div class="col-xs-2">
